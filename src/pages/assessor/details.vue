      ...
      <div class="q-py-md">
        <table>
          <tr class="tr-color">
            ...
            <td align="center" class="q-pa-sm">หมวด1</td>
            <td align="center" class="q-pa-sm">หมวด2</td>
            <td align="center" class="q-pa-sm">หมวด3</td>
            <td align="center" class="q-pa-sm">หมวด4</td>
            <td align="center" class="q-pa-sm">หมวด5</td>
            <td align="center" class="q-pa-sm">หมวด6</td>
            <td align="center" class="q-pa-sm">หมวด7</td>
            <td align="center" class="q-pa-sm">รวม</td>
          </tr>
          <tr v-for="(item,index) in officeData" :key="index">
            ...
            <td align="center" class="q-pa-sm">
              <span v-if="scoreTypeSelected == 'หน่วยงานประเมิน'">{{ item.cat1 }}</span>
              <span v-else>{{ item.cat1A }}</span>
            </td>
            <td align="center" class="q-pa-sm">
              <span v-if="scoreTypeSelected == 'หน่วยงานประเมิน'">{{ item.cat2 }}</span>
              <span v-else>{{ item.cat2A }}</span>
            </td>
            <td align="center" class="q-pa-sm">
              <span v-if="scoreTypeSelected == 'หน่วยงานประเมิน'">{{ item.cat3 }}</span>
              <span v-else>{{ item.cat3A }}</span>
            </td>
            <td align="center" class="q-pa-sm">
              <span v-if="scoreTypeSelected == 'หน่วยงานประเมิน'">{{ item.cat4 }}</span>
              <span v-else>{{ item.cat4A }}</span>
            </td>
            <td align="center" class="q-pa-sm">
              <span v-if="scoreTypeSelected == 'หน่วยงานประเมิน'">{{ item.cat5 }}</span>
              <span v-else>{{ item.cat5A }}</span>
            </td>
            <td align="center" class="q-pa-sm">
              <span v-if="scoreTypeSelected == 'หน่วยงานประเมิน'">{{ item.cat6 }}</span>
              <span v-else>{{ item.cat6A }}</span>
            </td>
            <td align="center" class="q-pa-sm">
              <span v-if="scoreTypeSelected == 'หน่วยงานประเมิน'">{{ item.cat7 }}</span>
              <span v-else>{{ item.cat7A }}</span>
            </td>
              <td align="center" class="q-pa-sm">
              <span v-if="scoreTypeSelected == 'หน่วยงานประเมิน'">{{ item.officeScore }}</span>
