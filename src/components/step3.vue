      ...
      data: [
        {
          ...
          basic: {
            mode: "basic",
            titleText: `- กระบวนการวางแผนยุทธศาสตร์อย่างเป็นระบบทั้งระยะสั้นและระยะ ยาว ตอบสนองความต้องการของประชาชนและบรรลุพันธกิจส่วน
ราชการ<br>
...
การเข้าถึงของภาคส่วนต่างๆ`,
              ...
              {
                text: `การกำหนดยุทธศาสตร์ แผนงานที่ตอบสนองต่อความ ท้าทาย และการเปลี่ยนแปลง`,
                status: false
              }
            ],
            explain: "",
...
ได้ง่ายและเข้าถึงได้ทุกที่ ทุกเวลา`,
        ...
        // ******************************************************************************************
        {
          ...
          basic: {
            ...
            checkBox: [
              {
                text: `มีแผนที่ยุทธศาสตร์ (Strategy Map) แผนระยะสั้นและแผนระยะ
ยาวที่ส่งผลต่อยุทธศาสตร์ชาติ`,
                status: false
              },
              {
...
เกิดกับยุทธศาสตร์ชาติทั้งระยะสั้นและระยะยาว`,
            checkBox: [
              {
                text: `มีการวิเคราะห์ผลกระทบของเป้าประสงค์และตัวชี้วัด ที่มีผลต่อ
ยุทธศาสตร์ชาติทั้งระยะสั้นและระยะยาว ในมิติต่างๆ เช่นการเพิ่ม
ขีดความสามารถในการแข่งขัน การลดผลกระทบจากข้อบังคับทาง
กฏหมาย `,
                status: false
              }
            ],
...
`,
            checkBox: [
              {
                text: `วิเคราะห์ความเสี่ยงระดับองค์การที่อาจเกิดขึ้น และส่งผลต่อ แผนงานและเป้าหมายที่วางไว้`,
                status: false
              },
              {
                text: `วิเคราะห์ความเสี่ยงระดับองค์การที่อาจเกิดขึ้น ที่อาจส่งผลกระทบ
ต่อระบบเศรษฐกิจ สังคม สาธารณสุข และ สิ่งแวดล้อมของ ประเทศ`,
                status: false
              }
            ],
            explain: "",
        ...
        // ***************************************2.3 *******************************************
        {
          ...
          advance: {
            mode: "advance",
            titleText: `- แผนปฏิบัติการที่สนับสนุนความสำเร็จของยุทธศาสตร์ของส่วน ราชการครอบคลุมทุกส่วนงานชัดเจน และเน้นการเกิดประสิทธิภาพ (การทำน้อยได้มาก) การสร้างคุณค่าแก่ประชาชน (Public value)`,
            checkBox: [
              {
                text: `ประสิทธิภาพควบคู่กับประสิทธิผล (การทำน้องได้มาก)`,
                status: false
              },
              {
          ...
          significance: {
            mode: "significance",
            titleText: `- แผนปฏิบัติการที่สนับสนุนความสำเร็จของยุทธศาสตร์ของส่วน ราชการ บูรณาการกับแผนงานด้านบุคลากรและการใช้ทรัพยากรที่ รองรับการเปลี่ยนแปลงที่จะเกิดขึ้น และสื่อสารสู่การปฏิบัติผ่าน เครือข่ายทั้งภายในและภายนอกและการใช้ข้อมูลร่วมกันเพื่อการประสาน
...
เพื่อรองรับการเปลี่ยนแปลง`,
        ...
        // ******************************************** 2.4 *****************************
        {
          header: `2.4 กาคติดตามผลของการบรรลุเป้าหมายเชิงยุทธศาสตร์ การแก้ไขปัญหา  และการรายงานผลอย่างมีประสิทธิผล`,
          status: -1, //สถานะของข้อ 0 = ยังไม่ผ่าน, 1 = ผ่าน Basic, 2 = ผ่าน Advance, 3 = ผ่าน Signi
          no: 4,
          // 2.4 basic
          basic: {
  ...
  methods: {
    ...
    getIMG(no, mode) {
      ...
      let imgFileName = `${this.$q.sessionStorage.getItem(
        "uid"
      )}-2-${no}-${mode}-${this.$q.sessionStorage.getItem("y")}.jpg`;
