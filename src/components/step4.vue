...
export default {
  data() {
    return {
      ...
      data: [
        {
          header: `3.1 ระบบข้อมูลและสารสนเทศที่ทันสมัยเพื่อการบริการประชาชนที่ทันสมัย รวดเร็ว และเข้าถึงในทุกระดับ`,
...
กันโดยรวบรวมข้อมูลจาก
<br>
- ช่องทางต่างๆ เช่น ผลสำรวจความพึงพอใจ แบบสอบถามความ
คิดเห็นการประชุมรวบรวมความคิดเห็นจากภายในองค์การ / ภายนอกองค์การ / เครือข่าย เป็นต้น
`,
                status: false
              },
              {
                text: `ฐานข้อมูลของส่วนราชการ`,
                status: false
              }
            ],
            explain: "",
...
`,
            checkBox: [
              {
                text: `ใช้ข้อมูลและเทคโนโลยีสารสนเทศ / ดิจิทัลและช่องทางการสื่อสาร
รูปแบบใหม่ ๆ (เช่น Mobile Application หรือ facebook ที่มี การรับส่งข้อมูลได้อย่างรวดเร็ว ทันการณ์) เพื่อ<br>
...
- ค้นหาความต้องการ ความคาดหวังของกลุ่มผู้รับบริการ ผู้มีส่วน
...
- กำหนดนโยบายเชิงรุกในการตอบสนองความต้องการและความ<br>
คาดหวังของผู้รับบริการและผู้มีส่วนได้ส่วนเสียทั้งปัจจุบันและ อนาคต
`,
                status: false
              }
            ],
...
ส่วนได้ส่วนเสียหลักเพื่อนำมาวิเคราะห์และปรับปรุงกระบวนการทำงาน`,
            checkBox: [
              {
                text: `ประเมินความพึงพอใจและความผู้กพันในรูปแบบที่เหมาะสมเพื่อ
...
- เป็นแนวทางในการวางแผนยุทธศาสตร์และการสร้างนวัตกรรม`,
        ...
        {
          header:
            "3.3 การสร้างนวัตกรรมการบริการ ที่สร้างความแตกต่างและตอบสนองความต้องการเฉพาะกลุ่มและต่างความต้องการ",
          status: -1, //สถานะของข้อ 0 = ยังไม่ผ่าน, 1 = ผ่าน Basic, 2 = ผ่าน Advance, 3 = ผ่าน Signi
          no: 3,
          // 3.3 basic
          basic: {
            mode: "basic",
            titleText: `- การบริการที่ตอบสนองความต้องการและความคาดหวังของกลุ่มผู้รับ บริการและผู้มีส่วนได้ส่วนเสียหลักและการถ่ายทอดสู่การปฏิบัติในทุก
หน่วยงานที่เกี่ยวข้อง`,
            checkBox: [
              {
                text: `มีกระบวนการในการทบทวนและการปรับปรุงการบริการอย่าง
ต่อเนื่อง`,
                status: false
              },
              {
                text: `มีช่องทางการสื่อสารที่สามารถเข้าถึงผู้รับบริการ และผู้มีส่วนได้
ส่วนเสียหลัก`,
                status: false
              },
              {
...
(Response and React)`,
          ...
          significance: {
            ...
            checkBox: [
              {
                text: `มีการตอบสนองกลับต่อข้อร้องเรียนอย่างรวดเร็ว แก้ปัญหาได้อย่างทันการณ์`,
                status: false
              },
              {
                text: `ใช้เทคโนโลยีดิจิทับ และพัฒนาระบบการสื่อสารเพื่อสร้างความ
